...
<body>
    ...
    <main>
        ...
        <section id="CGU">
            ...
            <ul>
                <li><strong>Invités</strong> : Accès limité aux informations sur les thèmes, consultation des numéros publics et demande d'inscription.</li>
                <li><strong>Abonnés</strong> : Accès à un espace personnalisé, gestion des abonnements aux thèmes, consultation et notation des articles, et proposition d'articles pour publication.</li>
                <li><strong>Responsables de thème</strong> : Gestion des abonnements et articles d'un thème, proposition d'articles pour publication et modération des discussions.</li>
                <li><strong>Editeurs</strong> : Gestion globale du magazine, administration des numéros et gestion des utilisateurs.</li>
            </ul>

            <h4>2.2. Fonctionnalités</h4>
            <ul>
                <li>Un accès personnalisé aux contenus selon le statut de l'utilisateur.</li>
                <li>Un système de recommandations d'articles basé sur l'historique de navigation.</li>
                <li>La possibilité de proposer des articles, de les suivre et d'interagir via un système de chat.</li>
                <li>Un système de gestion et modération des contenus par les responsables de thème et les éditeurs.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Toute utilisation frauduleuse du compte doit être signalée immédiatement.</li>
            </ul>

            <h4>3.2. Contenu et Conduite</h4>
            <ul>
                <li>Les utilisateurs s'engagent à respecter les lois en vigueur et à publier des contenus conformes aux règles de l'application.</li>
                <li>Tout propos offensant, discriminatoire ou illégal est interdit et peut entraîner la suppression du compte concerné.</li>
            </ul>

            <h3>4. Modération et Contrôle</h3>
            <ul>
                <li>Les responsables de thème et éditeurs sont habilités à modérer et supprimer les contenus non conformes.</li>
                <li>L'éditeur peut bloquer ou supprimer des comptes en cas de non-respect des CGU.</li>
            </ul>

            <h3>5. Gestion des Données Personnelles</h3>
            <ul>
                <li>Les informations personnelles collectées sont utilisées uniquement dans le cadre de l'application.</li>
                <li>Aucune donnée ne sera partagée sans consentement, sauf obligation légale.</li>
            </ul>

            <h3>6. Modification des CGU</h3>
            <ul>
                <li>Tech Horizons se réserve le droit de modifier les CGU à tout moment.</li>
                <li>Les utilisateurs seront informés des modifications et devront les accepter pour continuer à utiliser l'application.</li>
            </ul>
